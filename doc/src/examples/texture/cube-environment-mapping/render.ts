...
import top from "@/assets/examples/cube-map/sky/top.png"
import bottom from "@/assets/examples/cube-map/sky/bottom.png"
import left from "@/assets/examples/cube-map/sky/left.png"
import right from "@/assets/examples/cube-map/sky/right.png"
import front from "@/assets/examples/cube-map/sky/front.png"
import back from "@/assets/examples/cube-map/sky/back.png"
...
const sketch: SketchFn = ({ gl, canvas }) => {
  ...
  const cubeMap = new ImagesCubeTexture(gl, {
    top: top.src,
    bottom: bottom.src,
    left: left.src,
    right: right.src,
